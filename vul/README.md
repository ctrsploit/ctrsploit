...
| [cve-2022-0847](cve-2022-0847) | local privilege escalation and container escape in Linux kernel Dirty Pipe | :o: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :x: | :x: |
