...
| [cve-2026-46300](cve-2026-46300) | local privilege escalation and container escape in Linux kernel xfrm ESP-in-TCP Fragnesia path | :o: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :x: | :x: |
