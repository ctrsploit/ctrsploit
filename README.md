...
| &emsp;&emsp;└─[ebpf-bash](./vul/caps/sys_admin/ebpf/bash)       | abuse eBPF to inject malicious commands into <br>bash processes running on host                                                                                                                 | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark:  | :heavy_check_mark: | :heavy_check_mark: | :x:                |
| &emsp;&emsp;└─[ebpf-cron](./vul/caps/sys_admin/ebpf/cron)       | abuse eBPF to inject malicious job into host's <br>crontab                                                                                                                                      | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark:  | :heavy_check_mark: | :heavy_check_mark: | :x:                |
| &emsp;&emsp;└─[ebpf-execve](./vul/caps/sys_admin/ebpf/execve)   | abuse eBPF to hijack execve syscall to run <br>arbitrary commands                                                                                                                               | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark:  | :heavy_check_mark: | :heavy_check_mark: | :x:                |
| &emsp;&emsp;└─[ebpf-kubelet](./vul/caps/sys_admin/ebpf/kubelet) | abuse eBPF to leak services account token from <br>kubelet                                                                                                                                      | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark:  | :heavy_check_mark: | :heavy_check_mark: | :x:                |
