...
| └─[net](./vul/namespace/net)                                | shared host network namespace <br>breaks the network isolation                                                                                                                                     | -                  | :x:                | :x:                 | :x:                | :x:                | :x:                |
| &emsp;└─shijack                                             |                                                                                                                                                                                                    | -                  | -                  | -                   | -                  | -                  | -                  |
...
| └─[pid](./vul/namespace/pid)                                | shared host pid namespace breaks the <br>process isolation                                                                                                                                         | -                  | -                  | -                   | -                  | -                  | -                  |
