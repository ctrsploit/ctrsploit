...
const (
	asmPath = "material/static-shell-amd64.s"
	binPath = "material/static-shell-amd64.bin"
...
func main() {
	dir, err := os.MkdirTemp("", "ctrsploit-static-shell-payload-*")
	must(err)
	defer os.RemoveAll(dir)

	objPath := filepath.Join(dir, "static-shell-amd64.o")
	textPath := filepath.Join(dir, "static-shell-amd64.text")
