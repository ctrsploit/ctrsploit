...
.PHONY: all shell local build test help
...
# Include generate tasks
include make/Makefile.generate
...
help:
	...
	@echo "  make generate-cve-2026-46300 - Generate cve-2026-46300 payload artifacts"
